...
async function cargarDatosFirestore() {
    ...
    await Promise.all(directorQuerySnapshot.docs.map(async (directorDoc) => {
        ...
        const ArchivoComprobantePagoDirect = mesActual !== MesPagoDirect ? undefined : directorData.ArchivoComprobantePago;
        const EstadoComprobantePagoDirect = mesActual !== MesPagoDirect ? undefined : directorData.EstadoComprobantePago;
