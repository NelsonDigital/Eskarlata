...
function barra() {
    ...
    userDocumentRef.get().then((doc) => {
        ...
        $("#estado-compra-venta").addClass(datos.EstadoArchivoCompraVenta ? 'estado-' + datos.EstadoArchivoCompraVenta.toLowerCase() : 'estado-amarillo');
        $("#estado-cuentas-participacion").addClass(datos.EstadoCuentasParticipacion ? 'estado-' + datos.EstadoCuentasParticipacion.toLowerCase() : 'estado-amarillo');
        $("#estado-autorizacion-mejoras").addClass(datos.EstadoAutorizacionMejoras ? 'estado-' + datos.EstadoAutorizacionMejoras.toLowerCase() : 'estado-amarillo');
        $("#estado-comprobante-pago").addClass(datos.EstadoComprobantePago ? 'estado-' + datos.EstadoComprobantePago.toLowerCase() : 'estado-amarillo');
    });
}
