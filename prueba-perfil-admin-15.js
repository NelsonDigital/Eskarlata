...
const columnDefs = [
    ...
    { headerName: 'Habilitado', field: 'DatosHabilitarDirect', cellRenderer: crearSelectInhabilitar, filter: 'agTextColumnFilter' },
    { headerName: 'Datos completos', field: 'completadoDirect', cellRenderer: renderizarIcono, filter: 'agTextColumnFilter' },
    {
        ...
        children: [
            ...
            { headerName: 'Habilitado', field: 'DatosHabilitarAsesor', cellRenderer: crearSelectInhabilitar, filter: 'agTextColumnFilter' },
            { headerName: 'Datos completos', field: 'completadoAsesor', cellRenderer: renderizarIcono, filter: 'agTextColumnFilter' },
            {
                ...
                children: [
                    ...
                    { headerName: 'Habilitado', field: 'DatosHabilitarInversor', cellRenderer: crearSelectInhabilitar, filter: 'agTextColumnFilter' },
    ...
    await Promise.all(directorQuerySnapshot.docs.map(async (directorDoc) => {
        ...
        if (asesorQuerySnapshot.empty) {
            ...
            await Promise.all(asesorQuerySnapshot.docs.map(async (asesorDoc) => {
                ...
                const asesorItem = { NombreAsesor: NombreAsesor, Archivo_DocumentoAsesor: Archivo_DocumentoAsesor, CompraventaAsesor: CompraventaAsesor, CuentasParticipacionAsesor: CuentasParticipacionAsesor, AutorizacionMejorasAsesor: AutorizacionMejorasAsesor, completadoAsesor: completadoAsesor, UltimoPagoAsesor: UltimoPagoAsesor, pagosAsesor: pagosAsesor, DatosHabilitarAsesor: DatosHabilitarAsesor };
